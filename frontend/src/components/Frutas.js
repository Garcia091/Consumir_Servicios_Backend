...
const url = "http://localhost:3500/Fruta/";
                        ...
                        return (
                            <div className="col-md-4 " key={`item-navbar-${index}`}>
                                <div className="card mt-4">
                                    ...
                                    <button className="btn btn-primary" onClick={()=>{this.seleccionarCarro(frutas);this.modalInsertar()}}><FontAwesomeIcon icon={faEdit}/></button>
                      {" "}
                      <button className="btn btn-danger" onClick={()=>{this.seleccionarCarro(frutas);this.setState({modalEliminar: true})}}><FontAwesomeIcon icon={faTrashAlt}/></button>
                                    </div>
                                </div>
                            </div>
                        )
